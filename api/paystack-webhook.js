...
// Paystack sends webhooks here after payment events

import crypto from 'crypto';
import { db, FieldValue, auditLog, genRef, logTransaction, PAYSTACK_SECRET, paystackRequest } from './_lib/admin.js';
  ...
  if (event.event === 'charge.success') {
    ...
    try {
      ...
      await db.runTransaction(async (t) => {
        ...
        logTransaction(t, {
          userId, type: 'deposit', amount, status: 'completed', reference,
